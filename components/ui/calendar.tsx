    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-slate-400 hover:text-slate-200 border-slate-700 hover:bg-slate-800"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-slate-300 hover:bg-slate-700 hover:text-slate-100 aria-selected:opacity-100"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-amber-500 text-slate-900 hover:bg-amber-400 hover:text-slate-900 focus:bg-amber-500 focus:text-slate-900",
