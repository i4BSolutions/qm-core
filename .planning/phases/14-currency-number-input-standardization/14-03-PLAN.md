...
3. **Ensure empty fields show blank**:
   - Quantity should show blank when value is empty string
   - No "0" default display, no placeholder text
  </action>
...
5. **Ensure empty fields show blank**:
   - Remove any `placeholder="0"` or `placeholder="0.00"`
   - Empty fields should render blank (no placeholder text per CONTEXT.md)
  </action>
