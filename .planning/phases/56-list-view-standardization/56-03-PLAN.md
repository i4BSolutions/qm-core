...
@.planning/phases/56-list-view-standardization/56-02-SUMMARY.md
@app/(dashboard)/inventory/stock-out-requests/page.tsx
...
- Add QMHQ Ref column:
  ...
  ```
- "Items" column -> rename header to "Item" and keep the `N item(s)` pattern or show first item name
...
<task type="auto">
  ...
  <action>
Run a final verification across ALL 6 list pages to ensure consistency. This task depends on Plans 01 and 02 having completed (all 6 pages are now standardized).
