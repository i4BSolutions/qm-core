...
- Voiding shows toast with PO status and qty changes
  ...
  <done>
Invoice detail page uses voidInvoice server action, displays detailed success toast with cascade effects (PO status, qty changes), and handles stock-in block error gracefully.
  </done>
</task>
